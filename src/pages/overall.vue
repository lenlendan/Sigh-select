<template>
     <div class="wrap">
        ...
        <div class="college">
          <school-college v-bind:title="title" v-bind:college="college_obj"></school-college>
        </div>
    </div>
</template>
<script>
...
.contain-box .major,.contain-box .school,.contain-box .area {
    height: auto;
    display: flex;
}
.majors{
